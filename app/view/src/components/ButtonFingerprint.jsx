...
function ButtonFingerprint({ className, disabled, onClick, type, active }) {
    return (
        <button
            disabled={disabled}
            className={
        ...
        >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="" className="w-full h-full dark:fill-[#393632] dark:hover:fill-[#D5CDB8]" viewBox="0 0 16 16">
