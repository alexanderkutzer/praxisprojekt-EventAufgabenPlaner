            ...
            <div className="bg-white p-6 rounded-md shadow-md w-96 relative">
                ...
                {activeSection === "" && (
                    <ul className="space-y-4">
                        <li>
                            <button className="text-left w-full bg-gray-300 hover:bg-gray-500 px-4 py-2 rounded-md" onClick={() => setActiveSection("email")}>
                                Edit E-mail Address
                            </button>
                        </li>
                        <li>
                ...
                <div className="flex justify-end space-x-2 mt-4">
                    <button className="bg-gray-300 text-black px-4 py-2 rounded-md hover:bg-gray-500" onClick={() => setActiveSection("")}>
                        Cancel
                    </button>
                    <button className="bg-gray-300 text-black px-4 py-2 rounded-md hover:bg-gray-500" onClick={handleSaveChanges}>
                        Save Changes
                    </button>
                </div>
            </div>
