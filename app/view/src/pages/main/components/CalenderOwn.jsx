        ...
        <div className="w-full">
            <div className="w-full flex-col flex gap-2 ">
                ...
                <div
                    ...
                    className="grid grid-cols-8 border border-gray-500 rounded dark:text-[#D5CDB8]"
                >
                    <div className=" select-none border border-gray-500 w-full justify-center flex dark:text-orange-300">KW</div>
                    <div className=" select-none border border-gray-500 w-full justify-center flex dark:text-orange-300">Mo</div>
                    <div className=" select-none border border-gray-500 w-full justify-center flex dark:text-orange-300">Di</div>
                    <div className=" select-none border border-gray-500 w-full justify-center flex dark:text-orange-300">Mi</div>
                    <div className=" select-none border border-gray-500 w-full justify-center flex dark:text-orange-300">Do</div>
                    <div className=" select-none border border-gray-500 w-full justify-center flex dark:text-orange-300">Fr</div>
                    <div className=" select-none border border-gray-500 w-full justify-center flex dark:text-orange-300">Sa</div>
                    <div className=" select-none border border-gray-500 w-full justify-center flex dark:text-orange-300">So</div>

                    {calBoxes.map((calBox, index) => {
                        return index % 8 == 0 ? (
                            <div
                                key={index}
                                className="flex items-center justify-center border border-gray-500 w-full max-h-[42px] h-full select-none aspect-square text-gray-500 dark:text-orange-300 text-sm  "
                            >
                                {calBox.text}
                            </div>
                        ) : (
                            <div
                                ...
                                className={
                                    ...
                                    (calBox.active == false ? " text-gray-400 dark:text-[#949083] " : "") +
                                    (calBox.active2 == true ? " bg-orange-300 dark:text-[#393632]" : "")
                                }
                            >
