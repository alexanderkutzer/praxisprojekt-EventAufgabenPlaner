                ...
                {events.map((event, i) => (
                    <React.Fragment key={event.id}>
                        ...
                        <li
                            ...
                            className="my-[2px] dark:text-[#D5CDB8] sticky top-0 p-1 border bg-white dark:bg-[#393632]  border-gray-300 dark:border-[#D5CDB8] rounded-lg  z-10 "
                        >
                            <div
                                className={
                                    "border-2 hover:border-gray-700 dark:hover:border-[#D5CDB8] dark:border-[#393632] rounded " + (event.id === selectedEvent?.id && " border-orange-500 hover:border-orange-700 dark:border-orange-500 dark:hover:border-orange-700")
                                }
                            >
