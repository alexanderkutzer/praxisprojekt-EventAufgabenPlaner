...
function EventNew({
    ...
    return (
        <>
            <div className="flex flex-col gap-1 p-2 border border-gray-300 dark:border-[#D5CDB8] rounded-lg shadow-lg">
                <div>Title</div>
                <Input
                    type="text"
                    name="title"
                    ...
                    className="p-2 border rounded resize-none w-1/2 dark:border-[#D5CDB8]"
                />
                ...
                <Input
                    ...
                    onChange={handleInputChange}
                    className="p-2 border rounded resize-none w-1/2 text-gray-500 dark:border-[#D5CDB8]"
                />
                <div>Uhrzeit</div>
                <div>Farbe</div>
                <div>Aufgaben</div>
                ...
                <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Details"
                    className="p-2 border rounded h-32 dark:border-[#D5CDB8]"
                />
