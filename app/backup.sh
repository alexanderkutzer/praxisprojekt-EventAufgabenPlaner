...
# Backup-Pfade
DB_PATH="/home/ec2-user/praxisprojekt-EventAufgabenPlaner/app/api/data"   # Remote DB-Verzeichnis
BACKUP_NAME="database_backup_$(date +%d%m%Y).db"                          # Backup-Dateiname
LOCAL_BACKUP_DIR="$HOME/db_backups"                                       # Lokales Backup-Verzeichnis
